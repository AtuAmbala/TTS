...
def extract_metrics(pr, repo, headers):
    ...
    # Collecting the text from issue comments, review comments, reviews, and issue body
    ...
    reviews_text = " | ".join([review["body"] for review in reviews if "body" in review])
...
def main():
    ...
    metrics_list = []
    with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:  # Reduced the number of workers
